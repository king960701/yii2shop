...
<div class="login w990 bc mt10">
    ...
    <div class="login_bd">
        <div class="login_form fl">
            <form id="login" action="<?=\yii\helpers\Url::to(['member/login'])?>" method="post">
                ...
                <ul>
                    ...
                    <li class="checkcode">
                        ...
                        <a href="javascript:;" id="change_captcha"><img id="img_captcha" alt="" />
                            <span>看不清？换一张</span></a>
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
// 在键盘按下并释放及提交后验证提交表单
        $("#login").validate({
            rules: {
                username: {
                    ...
                    minlength: 2,
                    //远程异步验证
                    //remote: "<?=\yii\helpers\Url::to(['member/login-username'])?>",
                ...
                password_hash: {
                    ...
                    //remote: "<?=\yii\helpers\Url::to(['member/login-password'])?>",
                },
    ...
    $('#change_captcha').click(function(){
        ...
        $.getJSON('<?=\yii\helpers\Url::to(['site/captcha','refresh'=>1])?>',function(data){
            ...
            var hash = $('body').data('captcha',data.hash1);
