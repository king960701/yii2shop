...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        ...
        <h2>当前位置：<a href="">首页</a> > <a href=""><?=$top->name?></a> > <a href=""><?=$middle->name?></a> ><?=$good->name?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$gallery[0]['path']?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$gallery[0]['path']?>" alt="" width="350px"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$gallery[0]['path']?>',largeimage: '<?=$gallery[0]['path']?>'}"><img src="<?=$gallery[0]['path']?>"></a>
                            </li>
                            <?php unset($gallery[0])?>
                            <?php foreach ($gallery as $img):?>
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$img['path']?>',largeimage: '<?=$img['path']?>'}"><img src="<?=$img['path']?>"></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有人<?=$good->view_times?>浏览)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
